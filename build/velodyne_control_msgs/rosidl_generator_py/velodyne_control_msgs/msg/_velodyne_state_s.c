...
bool velodyne_control_msgs__msg__velodyne_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("velodyne_control_msgs.msg._velodyne_state.VelodyneState", full_classname_dest, 55) == 0);
  }
  velodyne_control_msgs__msg__VelodyneState * ros_message = _ros_message;
  {  // velocity
...
{
  /* NOTE(esteve): Call constructor of VelodyneState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("velodyne_control_msgs.msg._velodyne_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VelodyneState");
